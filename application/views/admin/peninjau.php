                    ...
                    <div class="x_title">
                        ...
                        <?=$this->session->flashdata('pesan')?>
                            <a class="btn btn-info" data-toggle="modal" data-target="#modalTambah">
                                <i class="fa fa-plus"></i> Tambah Peninjau</a>
                    </div>
                    <div class="x_content">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Hapus Peninjau</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?=base_url();?>admin/peninjau/hapus/<?=$p['id']?>" class="btn btn-primary">Ya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Edit Peninjau</h4>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Tambah Peninjau</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal form-label" action="<?=base_url();?>admin/peninjau/tambah" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-xs-12">
                            <select class="form-control" name="nidn" id="nidn">
                                ...
                                <?php if ($nidnDosen != null) { foreach ($nidnDosen as $d) {?>
                                <option>
                                    <?=$d['nidn']?>
                                </option>
                                <?php } 
